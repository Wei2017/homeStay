	...
	<div class="detail">
		...
		<div class="detail-con">
			...
			<div class="hotel-comment details-com">
				<div class="title">
					<h3>客房点评</h3>
					<span @click="jumpComment">全部评论(59)
			...
			<div class="hotel-position details-com">
				...
				<baidu-map class="bm-view" :center="detals.mapData.center" :zoom="detals.mapData.zoom" :scroll-wheel-zoom="true"
				 @ready="handler" ak="288jpGDll3P7KGTcENGEboLzqFWPImSG">
					<!-- :icon="{url: '/static/img/map_mark.png', size: {width: 53, height: 53}}" -->
					<bm-marker :position="detals.mapData.center" :dragging="true" animation="BMAP_ANIMATION_BOUNCE" :zIndex="999">
						<bm-label :content="detals.mapData.address" :labelStyle="detals.mapData.labelStyle" :offset="{width: -20, height: 60}" />
					</bm-marker>
				</baidu-map>
			...
			<div class="hotel-device details-com">
				<div class="title">
					<h3>配套设备</h3>
					<span @click="jumpHotlDevice">查看更多
						<van-icon name="arrow" /></span>
				</div>
				<div class="content">
					<div class="list">
						...
						<div class="rg-con">
							<span>
								<van-icon name="checked" />无线电视</span>
							<span class="clear">
								<van-icon name="clear" />无线电视</span>
						</div>
					</div>
					<div class="list">
						<div class="lf-con">
			...
			<div class="reserv-notice details-com">
				...
				<div class="content">
					...
					<div>
						<h4>提供发票</h4>
						<p class="invoice" @click="jumpInvoice">开具发票，点击进入发票说明页
							<van-icon name="arrow" />
						</p>
					</div>
					<div>
